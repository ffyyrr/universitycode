...
public class ViewController extends BaseController
{
	...
	public void article()
	{
		...
		setAttr("commentNum", commentSrv.getComments(id));//Comment数
		setAttr("postNum", viewSrv.getPostNum(post.getUserId()));//PublishArticle number
		setAttr("totalCommentNum", viewSrv.getCommentNum(post.getUserId()));//PublishComment数
		render("article.html");
	}
	...
	public void question()
	{
	  ...
	  /**
     * 如果用户已Login，则需要显示当前Video是否已经被该用户点赞了
     */
