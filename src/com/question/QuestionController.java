...
public class QuestionController extends BaseController
{
	...
	public void save()
	{
		...
		if (posts.save())
		{
			...
			ret2.set("msg", "Congratulations, Publish succeeded!");
			ret2.setOk();
			renderJson(ret2);
			//增加动态信息
		...
		renderJson(Ret.fail("msg", "对不起，Publish失败"));
		return;
	}
